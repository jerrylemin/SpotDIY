...
| Smart features and analytics | 14 | IN PROGRESS | docs closure (implementation through `dbcdb2f`) | 83 Vitest; typecheck/lint/build; Rust fmt; focused native/frontend coverage present | Schema 9, local history/sessions, smart rules/shuffle, analytics UI, private/temporary boundaries, and Plan 13 staging hardening are committed locally; native/package closure is pending the local toolchain/browser blockers. |
