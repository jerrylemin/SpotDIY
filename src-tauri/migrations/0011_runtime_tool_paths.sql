-- Plan 16: persist explicit yt-dlp and FFmpeg selections and enable valid
-- provider sources created by earlier schema versions for online playback.
CREATE TABLE settings_metadata_v11 (
...
INSERT INTO settings_metadata_v11 (
    setting_key,
    value_json,
    value_type,
    schema_version,
...
ALTER TABLE settings_metadata_v11 RENAME TO settings_metadata;
